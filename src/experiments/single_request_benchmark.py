...
for iteration in range(1, num_iterations + 1):
    ...
    for chunk in stream:
        if chunk.choices[0].delta.content:  # Check if content is present
            ...
            # Ensure usage and timings information is available
            if 'usage' in chunk and 'timings' in chunk:
                ...
                if prompt_tokens is not None:
                    ...
                    print(f"Warning: Missing prompt_tokens for iteration {iteration}, chunk {chunk['id']}")
...
print("Process completed after 25 iterations.")
